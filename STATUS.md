Обновлено: `2026-04-14 01:49:49` (Авто-обновление: 60 сек)

## ⚡ Статус Индексации: Индексация (в очереди)
- **Прогресс пачки**: `[0/10] (0.0%)`
- **Очередь RAG**: `21 док.` (Pending/Indexing)
- **Всего в RAG**: `383 (всего в базе)`
...
| :--- | :--- | :--- | :--- |
| **Ollama (Metal GPU)** | 10.00% | N/A | ✅ Active |
| **LightRAG API** | 48.20% | 432.3MiB | ✅ Online |
| **Neo4j DB** | 55.32% | 632.6MiB | ✅ Online |
| **Qdrant DB** | 2.83% | 207.2MiB | ✅ Online |
...
- [22:32:31] ✅ Документ проиндексирован (Neo4j): hlv_architecture_expert_guide.md
- [22:32:30] ▶️ Запуск скрипта мониторинга-дашборда V3.0
- [19:24:28] 🚨 Внутренняя ошибка скрипта дашборда: '>' not supported between instances of 'str' and 'float'
- [19:23:26] 🚨 Внутренняя ошибка скрипта дашборда: '>' not supported between instances of 'str' and 'float'
- [19:22:24] 🚨 Внутренняя ошибка скрипта дашборда: '>' not supported between instances of 'str' and 'float'
- [19:21:22] 🚨 Внутренняя ошибка скрипта дашборда: '>' not supported between instances of 'str' and 'float'